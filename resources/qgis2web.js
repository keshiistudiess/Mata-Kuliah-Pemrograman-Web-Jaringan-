...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [108.518231, -6.796387, 108.591098, -6.690882],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([108.444199, -6.784588, 108.670850, -6.661460], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA BATAS ADMINISTRASI KECAMATAN KOTA CIREBON</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (239 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta Batas Administrasi Kecamatan Kota Cirebon, Jawa Barat, Indonesia. Sumber data dari: https://tanahair.indonesia.go.id/portal-web/ dan https://geoservices.big.go.id/portal/apps/webappviewer/index.html?id=cb58db080712468cb4bfd408dbde3d70';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_RBI10K_ADMINISTRASI_AR_DESA_1,
    colName: 'NAMOBJ',
    zoom: 10,
    collapsed: true,
    map: map,
